"""
frontend/pages/3_Compare_Resumes.py — HR Compare Candidates

Thin wrapper that renders the Compare Candidates section of the HR dashboard
...
from frontend.admin_dashboard import _init_hr_state, _load_results, _render_compare

st.set_page_config(page_title="ResumeIQ — Compare", page_icon="", layout="wide")
inject_styles()
...
<div class="card" style="text-align:center;padding:50px;border-style:dashed">
 ...
 <div style="color:var(--muted2);font-size:0.88rem;margin-top:8px;max-width:440px;margin-left:auto;margin-right:auto">
  ...
  _render_compare(ranking_df, extracted)
