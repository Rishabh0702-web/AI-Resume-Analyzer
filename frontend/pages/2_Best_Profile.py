"""
frontend/pages/2_Best_Profile.py — HR Top Profiles

Thin wrapper that renders the Best Profiles section of the HR dashboard
...
from frontend.admin_dashboard import _init_hr_state, _load_results, _render_best_profiles

st.set_page_config(page_title="ResumeIQ — Best Profiles", page_icon="", layout="wide")
inject_styles()
...
<div class="card" style="text-align:center;padding:50px;border-style:dashed">
 ...
 <div style="color:var(--muted2);font-size:0.88rem;margin-top:8px;max-width:440px;margin-left:auto;margin-right:auto">
  ...
  _render_best_profiles(ranking_df, extracted)
